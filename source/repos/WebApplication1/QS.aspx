<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QS.aspx.cs" Inherits="WebApplication1.QS" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="Button1" runat="server" CssClass="auto-style5" Text="Submit" Width="200px" OnClick="Button1_Click" />
        </div>
    </form>
</body>
</html>

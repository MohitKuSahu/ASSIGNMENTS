<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDetails2.aspx.cs" Inherits="DemoUserManagement.UserDetails2" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="registrationForm" class="needs-validation">
        <center>
        ...
        <div class="container1 ">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-4 position-relative">
                    ...
                    <input type="file" class="form-control" id="docUpload" required>
                    <div class="invalid-tooltip">
                        Please fill up
                    </div>
                </div>

...
public partial class EmployeelistContext : DbContext
{
    ...
    public virtual DbSet<EmployeeesList> EmployeeesLists { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeeesList>(entity =>
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04F110020F746");
